...
GS_IMAGES_BMP = $(wildcard $(TO_EXTRACT_AND_COMPRESS_GS_PATH)/*.bmp)
GS_IMAGES_RAW = $(patsubst $(TO_EXTRACT_AND_COMPRESS_GS_PATH)/%.bmp,$(TO_COMPRESS_PATH)/%.raw,$(GS_IMAGES_BMP))
...
$(TO_COMPRESS_PATH)/$(1).raw: $(TO_EXTRACT_AND_COMPRESS_GS_PATH)/$(1).bmp
