    ...
    global ay8910_queue_sequence_wall_collision, ay8910_queue_sequence_start_beep_1, ay8910_queue_sequence_start_beep_2
...
chain_sequence_start_beep_1:
    dc.b AY_SOUND_CHAIN_START_BEEP_1, AY_SOUND_CHAIN_NUMBER_SILENCE
chain_sequence_start_beep_1_end:

chain_sequence_start_beep_2:
    dc.b AY_SOUND_CHAIN_START_BEEP_2, AY_SOUND_CHAIN_START_BEEP_2, AY_SOUND_CHAIN_START_BEEP_2, AY_SOUND_CHAIN_NUMBER_SILENCE
chain_sequence_start_beep_2_end:

AY_SOUND_CHAIN_NUMBER_SILENCE equ 1
AY_SOUND_CHAIN_NUMBER_PLAY_TONE equ 2
AY_SOUND_CHAIN_NUMBER_PLAY_CRASH equ 3
AY_SOUND_CHAIN_START_BEEP_1 equ 4
AY_SOUND_CHAIN_START_BEEP_2 equ 5
...
command_chains:
    ...
    dc.w ay8910_command_chain_play_start_beep_1
    dc.w ay8910_command_chain_play_start_beep_2
...
ay8910_command_chain_play_start_beep_1:
    dc.b (ay8910_command_chain_play_start_beep_1_end-ay8910_command_chain_play_start_beep_1-1)/2
    dc.b AY8910_REGISTER_MIXER, AY8910_MASK_MIXER_TONE_A&AY8910_MASK_MIXER_TONE_B&AY8910_MASK_MIXER_TONE_C&AY8910_MASK_MIXER_PORT_A_IN&AY8910_MASK_MIXER_PORT_B_IN
    dc.b AY8910_REGISTER_FREQUENCY_C_LOWER,$8e
    dc.b AY8910_REGISTER_FREQUENCY_C_UPPER,0
    dc.b AY8910_REGISTER_VOLUME_C, 15
ay8910_command_chain_play_start_beep_1_end:

ay8910_command_chain_play_start_beep_2:
    dc.b (ay8910_command_chain_play_start_beep_2_end-ay8910_command_chain_play_start_beep_2-1)/2
    dc.b AY8910_REGISTER_MIXER, AY8910_MASK_MIXER_TONE_A&AY8910_MASK_MIXER_TONE_B&AY8910_MASK_MIXER_TONE_C&AY8910_MASK_MIXER_PORT_A_IN&AY8910_MASK_MIXER_PORT_B_IN
    dc.b AY8910_REGISTER_FREQUENCY_C_LOWER,$47
    dc.b AY8910_REGISTER_FREQUENCY_C_UPPER,0
    dc.b AY8910_REGISTER_VOLUME_C, 15
ay8910_command_chain_play_start_beep_2_end:
...
ay8910_queue_sequence_start_beep_1:
    ld bc,chain_sequence_start_beep_1_end-chain_sequence_start_beep_1
    ld hl,chain_sequence_start_beep_1
    jr ay8910_inject_chain_sequence_in_chain_queue

ay8910_queue_sequence_start_beep_2:
    ld bc,chain_sequence_start_beep_2_end-chain_sequence_start_beep_2
    ld hl,chain_sequence_start_beep_2
    jr ay8910_inject_chain_sequence_in_chain_queue
