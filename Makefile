...
$(COMPRESSED_FILES_INCLUDER): $(EXTRACTED_TO_COMPRESS) $(TO_COMPRESS_PATH)/circuitdata.bin $(TO_COMPRESS_PATH)/introscreen.raw
...
$(HUFFMAN_COMPRESSOR_SOURCE_FILE) $(COMPRESSED_FILES_INCLUDER) $(COMPRESSED): $(TO_COMPRESS_ALL) $(HUFFMAN_PATH) $(TO_COMPRESS_PATH) $(TO_COMPRESS_PATH)/introscreen.raw
...
ifneq ($(wildcard $(SAVESTATE)),)
	...
	cd $(TO_COMPRESS_PATH) & del introscreen.raw
